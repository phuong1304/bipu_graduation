    ...
    <div className="min-h-screen bg-[linear-gradient(135deg,_#08031f,_#120b3d,_#1f0f59)] relative overflow-hidden">
      ...
      <div className="min-h-screen flex items-center justify-center p-4 sm:p-6 lg:p-10 relative z-10">
        <div className="w-full max-w-5xl">
          <div className="bg-gradient-to-r from-rose-300 via-sky-300 to-indigo-300 p-[1px] rounded-[2.75rem] shadow-[0_25px_70px_rgba(8,5,30,0.65)]">
            <div className="bg-white/95 backdrop-blur-lg rounded-[2.65rem] grid gap-0 lg:grid-cols-2 overflow-hidden">
              <section className="p-8 sm:p-10 lg:p-12 border-b border-gray-100/70 lg:border-b-0 lg:border-r space-y-6">
                <div className="flex items-center justify-center lg:justify-start gap-3 text-indigo-500 text-xs tracking-[0.35em] font-semibold uppercase">
                ...
                <div className="text-center lg:text-left space-y-3">
                  <p className="text-sm font-semibold text-slate-500 uppercase tracking-[0.3em]">
                    Vũ Thị Bích Phương · Đại học FPT
                  </p>
                  ...
                  <p className="text-slate-600">
                    Đăng nhập để mở thiệp mời, xác nhận tham dự và cập nhật mọi hoạt động của Convocation Day.
                  </p>
                </div>

                <div className="rounded-[2.2rem] border border-indigo-100 overflow-hidden shadow-2xl">
                  <img src={gradPhoto} alt="Vũ Thị Bích Phương" className="w-full h-64 sm:h-72 object-cover object-center" />
                </div>
              ...
              <section className="p-8 sm:p-10 lg:p-12 bg-gradient-to-br from-indigo-50 via-white to-rose-50 flex items-center">
                <div className="space-y-6 w-full">
                  <div className="text-center lg:text-left">
                    <p className="text-xs font-semibold text-indigo-400 uppercase tracking-[0.5em] mb-2">
                      Đăng nhập
                    </p>
                    <h2 className="text-2xl font-bold text-slate-900">Trải nghiệm thiệp mời số</h2>
                  </div>

                  <form className="space-y-5" onSubmit={handleSubmit}>
                    <div>
                      <label className="text-sm font-semibold text-slate-700 mb-2 block">Tên người tham gia</label>
                      <input
                        type="text"
                        value={username}
                  ...
                  <div className="text-xs text-slate-500 flex items-center gap-2">
                    ...
                    Thông tin đăng nhập chỉ phục vụ cho Convocation Day 20/11/2025.
                  </div>
                </div>
              </section>
            </div>
