...
import { AppUser, ParticipantRecord } from "@/lib/supabase/types";
  ...
  return (
    <div className="flex flex-wrap justify-center gap-4">
      ...
      <button
        ...
        className={`group relative px-8 py-4 font-bold rounded-full shadow-lg transform transition-all duration-300 overflow-hidden ${hasResponded
      ...
      >
        <span className="relative z-10 flex items-center gap-2">
          <GraduationCap
            className={`w-5 h-5 ${!hasResponded ? "group-hover:animate-heartbeat" : ""
              }`}
          />
