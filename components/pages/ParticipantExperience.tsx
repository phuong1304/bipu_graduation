  ...
  return (
    ...
    >
      ...
      <div className="min-h-screen flex items-center justify-center p-4 sm:p-6 md:p-8">
        <div
          className={`max-w-4xl  w-full transform transition-all duration-1000 ${isVisible ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"
            }`}
        >
                      ...
                      >
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <button
                              ...
                              className="flex items-center justify-center border border-rose-200 rounded-full w-8 h-8 hover:bg-rose-50 transition"
                            >
                              <img src="/assets/icon/send.svg" alt="" className="w-4 h-4" />
                        ...
                        <div
                          className={`
                            ...
                            max-h-[400px]  ${user.invited_to_dinner
                              ? "lg:max-h-[400px]"
                              : "lg:max-h-[270px] "
                            }
                          `}
                      ...
                      {[
                        ...
                        return (
                          ...
                          >
                            ...
                            >
                              <Copy
                                className={`w-4 h-4 ${copied ? "text-green-500" : "text-amber-500"
                                  } transition-colors`}
                              />
                            </button>
                          </div>
...
function InfoPill({ icon, title, accent, children }: InfoPillProps) {
  return (
    <div className="flex flex-col items-center justify-start gap-3 rounded-2xl border border-slate-100 bg-white/90 p-4 text-center shadow">
      ...
      <div className="text-base font-medium text-slate-700 text-balance">
        {children}
      </div>
    </div>
  );
