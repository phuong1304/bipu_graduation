...
import type { ParticipantRecord, ParticipantUpsertInput } from "@/lib/supabase/types";
import { upsertParticipant, deleteParticipants } from "@/app/actions/participants";
import { getWishes, deleteWish } from "@/app/actions/wishes";
      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-inner">
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex gap-4 flex-row-reverse">
            ...
            >
              <Loader
                className={`w-4 h-4 ${isLoading ? "animate-spin text-indigo-500" : "text-slate-500"
                  }`}
              />
              <span>Tải lại</span>
            </button>
          ...
          <div className="flex flex-col gap-3 mb-4">
            <div className="inline-flex rounded-full bg-slate-100 p-1 shadow-inner w-fit">
              {[
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-full text-sm font-semibold transition ${activeGroup === group.key
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 flex-1">
              ...
              <FilterSelect
                ...
                onChange={(val) => setCeremonyFilter(val as RSVPFilter)}
              >
              ...
              {activeGroup === "invited" && (
                <FilterSelect
                  ...
                  value={dinnerFilter}
                  onChange={(val) => setDinnerFilter(val as RSVPFilter)}
                >
                  <option value="all">Tat ca</option>
                  <option value="pending">Chua phan hoi</option>
